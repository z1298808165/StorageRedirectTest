...
- 场景脚本创建的 `Download/Srt*`、`Pictures/SrtLocked`、`DCIM/SrtFuse*` 等固定测试目录，以及固定文件 `srt_ci_probe.part`、`srt_qmark*.txt`、`srt_mountns_*_media.bin`、`srt_fuse_*_media.bin` 和文件监视专用 `srt_monitor_*.bin`。
